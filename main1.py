...
class SingingTwice:
    SONG_LIST = ["CHEER UP", "FANCY", "FEEL SPECIAL"]

    def __init__(self, log_file=None):
        logging.basicConfig(level=logging.INFO, format='%(message)s')
        self.logger = logging.getLogger("SingingTwice")
    ...
    def stop(self, signum, frame):
        self.__stop = True
        self.logger.info("Receive Signal {0}".format(signal))
